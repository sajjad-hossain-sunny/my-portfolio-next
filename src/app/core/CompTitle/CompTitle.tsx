  ...
  return (
    <>
      <div className="relative mb-8 md:mb-12">
          <h3 className="text-52 landscape:text-7xl landscape:md:text-8xl md:text-8xl lg:text-130 font-bold text-secondary-100 text-center uppercase select-none">{title}</h3>
